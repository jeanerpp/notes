 ...
 * updates: mirrors.cat.pdx.edu
   ...
   root@EAT /home/xujian/tmp # openssl x509 -in emc_root.cer -inform der -outform pem -out emc_root.pem
   root@EAT /home/xujian/tmp # cp emc_root.pem /etc/pki/ca-trust/source/anchors/
...
** VS code for python virtualenv
   ...
   $ cat bugreport/.vscode/settings.json
   {
       "python.pythonPath": "${workspaceFolder}/bin/python"
   }

   my vscode config:
   $ more ./.config/Code/User/settings.json
   {
